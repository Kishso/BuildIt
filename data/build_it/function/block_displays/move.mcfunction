...
execute if entity @s[tag=BuildIt_BlockDisplayInteraction] run execute as @e[tag=CurrentTargetDisplayEntity] at @s run function build_it:block_displays/geometry/align_display_from_rotate
