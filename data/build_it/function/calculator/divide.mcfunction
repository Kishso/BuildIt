...
$data modify storage build_it:calculator divide.input1 set value $(input1) 
$data modify storage build_it:calculator divide.input2 set value $(input2) 

execute store result score Input1 sf_Calculator run data get storage build_it:calculator divide.input1 1000
execute store result score Input2 sf_Calculator run data get storage build_it:calculator divide.input2 1000
...
data remove storage build_it:calculator divide