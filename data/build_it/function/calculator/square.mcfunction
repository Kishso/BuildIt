...
$data modify storage build_it:calculator square.input set value $(input) 

execute store result score Input sf_Calculator run data get storage build_it:calculator square.input 1000

scoreboard players operation Result sf_Calculator = Input sf_Calculator 
scoreboard players operation Result sf_Calculator *= Input sf_Calculator
...
data remove storage build_it:calculator square