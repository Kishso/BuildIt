...
data modify entity @e[type=minecraft:interaction, tag=BeingPlaced, limit=1] data.cursor_display set from entity @e[type=minecraft:item_display, tag=BeingPlaced, limit=1] UUID
