...
execute if entity @s[y_rotation=135..-135, x_rotation=-45..45] run execute as @e[team=TargetEntities] run function build_it:move/north {step:100}
execute if entity @s[y_rotation=-135..-45, x_rotation=-45..45] run execute as @e[team=TargetEntities] run function build_it:move/east {step:100}
execute if entity @s[y_rotation=-45..45, x_rotation=-45..45] run execute as @e[team=TargetEntities] run function build_it:move/south {step:100}
execute if entity @s[y_rotation=45..135, x_rotation=-45..45] run execute as @e[team=TargetEntities] run function build_it:move/west {step:100}

execute if entity @s[x_rotation=-90..-45] run execute as @e[team=TargetEntities] run function build_it:move/up {step:100}
execute if entity @s[x_rotation=45..90] run execute as @e[team=TargetEntities] run function build_it:move/down {step:100} 
