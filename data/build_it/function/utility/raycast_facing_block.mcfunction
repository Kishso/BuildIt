...
execute unless entity @e[type=minecraft:armor_stand, tag=BuildIt_RaycastStand] run say "Create Armor Stand"
...
execute as @e[type=minecraft:armor_stand, tag=BuildIt_RaycastStand, sort=nearest, limit=1] at @s rotated as @s unless block ~ ~ ~ #air run say "Non-air block detected"
...
$execute unless entity @e[type=minecraft:armor_stand, tag=BuildIt_RaycastStand, distance=..$(max_distance)] run say "Target Block not Found!"
...
execute if data storage build_it:functions raycast.inProgress run data modify storage build_it:functions raycast.result.last_air_block set from entity @e[type=minecraft:armor_stand, tag=BuildIt_RaycastStand, sort=nearest, limit=1] Pos
